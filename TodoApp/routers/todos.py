...
@router.get("/todo/get_todo_by_id/{todo_id}", status_code=status.HTTP_200_OK)
...
@router.post("/todo/addtodo", status_code=status.HTTP_201_CREATED)
...
@router.delete("/todo/deletetodo/{todo_id}", status_code=status.HTTP_202_ACCEPTED)
